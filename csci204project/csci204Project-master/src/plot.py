...
class MyPlot:
    ...
    def twoDScatter(xList, yList, xLabels=None, yLabels=None):
        '''
        Pre: xList, yList are lists of integers. xLabels, yLabels are strings
        Post: Returns a scatter plot with xList, yList containing x and y values
        '''
        #Get x and y values
        y = yList
        x = xList
    ...
    def twoDBar(xList, yList, xLabels=None, yLabels=None):
        '''
        Pre: xList, yList are lists of integers. xLabels, yLabels are strings
        Post: Returns a bar graph with xList, yList containing x and y (height) values
        '''
        #Get x and y values
        y = yList
        x = xList
